      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm max-w-xs">
            Premium quality leather bags for the modern lifestyle.
          </p>
        </div>
        ...
        <div>
          ...
          <address className="not-italic text-gray-400 text-sm flex flex-col space-y-2">
            <p>Tairawt Vibe</p>
            <p>Setif, Beni Aziz</p>
            <p>Phone: (213) 4 56 78 90</p>
            <p>
              Email:{" "}
              <a className="hover:text-white transition">sylonbags@gmail.com</a>
            </p>
          </address>
